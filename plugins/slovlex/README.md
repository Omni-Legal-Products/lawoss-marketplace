# Slov-Lex – právne predpisy SR · LAWOSS
...
Refresh the marketplace with `codex plugin marketplace upgrade lawoss`, then reinstall `slovlex@lawoss`. The [central updater](../../docs/updating.md) can update selected installed LAWOSS plugins together. Start a new task after updating. Local plugin updates do not deploy hosted servers.
